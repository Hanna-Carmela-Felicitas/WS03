...
<?php loadPartial('navbar'); ?>
    ...
    <section class="min-h-screen bg-gray-50 flex justify-center items-center py-20 px-6">
      <div class="bg-white/95 backdrop-blur-md p-10 rounded-3xl shadow-2xl border border-gray-100 w-full max-w-4xl">
        <h2 class="text-4xl text-center font-bold mb-4">Edit Creative Opportunity</h2>
        <p class="text-gray-500 text-center mb-8"> 
          Update your listing and keep your creative opportunity fresh.
        </p>
        ...
        <form method="POST" action="/listings/<?= $listing->id ?>">
          ...
          <div class="mb-4">
            <input
              ...
              name="phone"
              placeholder="Phone"
              class="w-full px-5 py-3 rounded-2xl border border-gray-200 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-purple-400 transition" value="<?= $listing->phone ?? '' ?>"
            />
          </div>
          <div class="mb-4">
            <input
